...
Please note that up to 2010-11 the course was called MI451, and the course was subsequently called MY451 through 2017-18, so some older materials will bear those course codes. For example, you will find past
examination papers on the Library website under MI451 and MY451.
...
-   **Teachers responsible**: Jonathan Jackson (MT) & Ben Lauderdale (LT)

-   **Other Lecturers**: Ellie Power (LT)

-   **Course Administrator**: Esther Heyhoe, email `e.heyhoe@lse.ac.uk`

-   **Class Teachers**: MT: Sophie Loup, Jenny Chanfraeu, Yan Wang, George Maier, Tamara Shengelia, Joel Suss, Vikas Chandra, Cong Peng, Nelson Ruiz-Guarin, Matt Sharp, Baris Ari, Tom Paskhalis and Thiago Oliveira
...
-   **Lectures**: Ten two-hour lectures in weeks 1 - 5 and 7 - 11:
    ...
    -   Michaelmas Term (MY464M): Thu 2.00pm - 4.00pm in the Peacock
        Theatre

    -   Lent Term (MY464L): Wed 2.00pm - 4.00pm in the Hong Kong
        Theatre (CLM.G.02)
...
-   **Computer classes**: Each student will attend a one-hour class each
    ...
    first lecture and on the MY464 Moodle page. Please do not change the
...
-   **Coursepack**: This coursepack is the main course text. Printed
    ...
    copy will be given at the first lecture and on the MY464 Moodle
...
at the latest by 5pm in MT and by 10am in LT. Please see the MY464
...
For many of you, MY464 is only one part of a package of methods training
with a course code such as MC4M1 or MY4M1. If this is the case, your
result for MY464 will contribute only part of the final mark for the
...
MY464 under different examination regulations depending on which
department they are in and what degree they are registered for. For some
degrees a pass in MY464 is required, for others the mark from MY464 is
just one component of an overall course mark (implying a “pass” mark in
MY464 is not required). The regulations for your degree are not set by
Methodology, but by your home department. To find out whether a pass in
MY464 is required, consult your degree regulations or ask the tutor
