...
Homework should be submitted by 5pm, two weekdays after your computer class (eg Monday for a Thursday class, Tuesday for a Friday class).
...
There will be a **two-hour examination in the LENT Term**. You may bring two, two-sided A4 sheets of reference material to consult during the exam. This can be typed or handwritten, and prepared yourself or in collaboration with others. You are required to bring your own calculators for the
...
Class                           Descriptive statistics for categorical variables
...
Class                           Descriptive statistics for continuous variables
...
Class                           Analysis of two-way contingency tables
...
Class                           Inference for means in two populations
...
Class                           Inference for proportions in one and two populations
...
Class                           Correlation and simple linear regression
...
Class                           More on linear regression
...
Class                           multiple linear regression
