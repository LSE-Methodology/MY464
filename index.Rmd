...
_   **Applied exercises**: Each week there will be an exercise for students to complete 
    in which the ideas covered in the lecture for that week will be applied to a real
    data set using the software package R/RStudio. Each class will have an accompanying
    explanatory video and a multiple-choice quiz to be completed on Moodle to check
    your learning. 

-   **Classes**: Students will attend a one-hour class each
    week, **starting in Week 2**. Classes will be available to attend in person
    and online. Please consult the on-line timetables for the
    times and locations of the class groups. The allocation of students to
...
Class                           Introduction to R/RStudio 
...
Reading Week                    **No lecture, no class**
...
**Why do we use R/RStudio? I’ve heard that SAS/STATA/MINITAB/SPSS/LIMDEP is much
