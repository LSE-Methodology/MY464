...
population}.
(\#eq:H0-chi2)
\end{equation} In our example the null hypothesis is thus that a
...
population}.
(\#eq:Ha-chi2)
\end{equation} In terms of conditional distributions, $H_{a}$ is that
...
-   Finally, aggregating these quantities to get the $\chi^{2}$ test
    statistic \begin{equation}
    \chi^{2} = \sum \frac{(f_{o}-f_{e})^{2}}{f_{e}}.
    (\#eq:chi2)
    \end{equation} Here the summation sign $\Sigma$ indicates that
